...
(function() {
    var frenchwords = [
            'Soutien technique',
            'DÃ©veloppement des affaires',
            'Entreprise immobiliÃ¨re',
            'Analyse du marchÃ© des parts',
            'MÃ©tÃ©o et environnement',
            'Service financier et bancaire',
            'Services informatiques et rÃ©seau',
            'Services de restauration',
            "Service de dÃ©fense et d'incendie",
            'Services de livraison Ã  domicile'
        ],
        i = 0;
    setInterval(function() {
